...
def all_books():
    ...
    if request.method == "POST":
        ...
        to_search = request.form.get('search').lower()
        search_result = []
        for book in books: 
            if to_search in book.title.lower() or to_search in book.author.lower():
                search_result.append(book)
            
        return render_template('all_books.html', books=search_result)
